...
const Restaurants = require("../lab3_restaurant_database/restaurantModel.js");
const uri = "mongodb+srv://admin:ecovkaCADVOZesrR@fullstack.wto8w.mongodb.net/";
...
const seed = (db) => {
  ...
  console.log("Running the seed data.");
};
